...
<html lang="en">
    ...
    <head>
        ...
        <title>Semua Data Approval</title>
        <?php 
        ...
        <div class="panel container panel-default bg-body-tertiary">
            <div class="panel-body py-2">
                <div class="panel-heading">
                    <h4 class="panel-title">Semua Data Approval</h4>
                                    ...
                                    <div class="d-table">
                                        <table class="table-layout" id="example1">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                <tr>
                                                    <td class="table-layou-2 text-center"><?php echo $no; ?></td>
                                                    <td class="table-layou-2 text-center">
                                                    ...
                                                    <td class="table-layou-2 text-center">
                                                        ...
                                                        <?php if($data['hrd_app'] == 1): ?>
                                                        <a href="" target="_blank"
                                                            class="btn btn-warning btn-xs">Cetak</a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
                                                <?php
