...
<html lang="en">
    ...
    <head>
        ...
        ?>
        <script src="../approval/script.js" crossorigin="anonymous"></script>
    </head>
        ...
        <div class="panel container panel-default bg-body-tertiary">
            <div class="panel-body py-2">
                <div class="panel-heading">
                    <h4 class="panel-title">Approved</h4>
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?page=approval" aria-current="page" class="text-primary text-decoration-none">
                                Approved
                            </a>
                        </li>
                    </div>
                                    ...
                                    <div class="d-table">
                                        <table class="table-layout" id="example1">
                                            ...
                                            <tbody>
                                                <?php 
                                                    $no = 1;
                                                    $sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.npp=employee.npp AND cuti.hrd_app='1' ORDER BY cuti.tgl_pengajuan DESC";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="table-layout-2 text-center">
                                                        <?php echo $data['tgl_pengajuan'] ?></td>
                                                    <td class="table-layout-2 text-center">
                                                        <?php echo $data['tgl_awal'] ?></td>
                                                    <td class="table-layout-2 text-center">
                                                        <?php echo $data['tgl_akhir'] ?></td>
                                                    <td class="table-layout-2 text-center">
                                                        ...
                                                        <a href="?page=cetak&no=<?php echo $data['no_cuti'];?>"
                                                            aria-current="page" class="btn btn-primary" target="_blank"
                                                            onclick="return confirm('Apakah anda ingin print data ini ?')">
