...
<html lang="en">
    ...
    <head>
        ...
        <title>Data Approval Cuti</title>
        <?php 
            ...
            <div class="panel-body py-2">
                <div class="panel-heading">
                    ...
                    <div class="breadcrumb d-flex justify-content-end align-items-end flex-wrap">
                        ...
                        <li class="breadcrumb breadcrumb-item">
                            <a href="?page=approval-cuti" aria-current="page" class="text-primary text-decoration-none">
                                Data Approval Cuti
                            </a>
                        </li>
                    </div>
                                    ...
                                    <table class="table-layout" id="tabel-data">
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                cuti.manager = '$_SESSION[supervisor]' and cuti.stt_cuti='Menunggu Approval Supervisor' ORDER BY cuti.tgl_pengajuan DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center table-layout-2">
                                                    <a href="#myModal" aria-current="page"
                                                        data-load-code="<?php echo $pecah['no_cuti']; ?>"
                                                        class="btn btn-sm btn-warning btn-outline-light">
                                                        <i class="fa fa-eye fa-1x"></i>
                                                    </a>
                                                    <a href="?page=approval-review&no=<?php echo $pecah['no_cuti'];?>"
                                                        aria-current="page"
                                                        onclick="return confirm('Apakah anda ingin review data ini ?');"
                                                        class="btn btn-sm btn-warning btn-outline-light">
