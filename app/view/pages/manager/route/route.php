...
if(!isset($_GET['page'])){
    ...
    # Approval Manager
    case 'approval-cuti':
        require_once("../../manager/approval/approval_cuti.php");
        break;
        
    case 'approval-all':
        require_once("../../manager/approval/approval.php");
        break;

     case 'approval-review':
        require_once("../../manager/approval/approval_review.php");
        break;
    ...
    # Cuti Manager
    case 'cuti_create':
        require_once("../../manager/cuti/cuti_create.php");
        break;
    case 'cuti_waitapp':
        require_once("../../manager/cuti/cuti_waitapp.php");
        break;
    case 'cuti_reject':
        require_once("../../manager/cuti/cuti_reject.php");
        break;
    case 'cuti_app':
        require_once("../../manager/cuti/cuti_app.php");
        break;
    case 'cuti_detail':
        require_once("../../manager/cuti/cuti_detail.php");
        break;
    # Cuti Manager
