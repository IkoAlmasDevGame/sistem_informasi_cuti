        ...
        <ul>
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" role="button"
                    ...
                    <?php $npp = $_SESSION['manager']; $data = mysqli_query($konfigs, "SELECT * FROM employee WHERE npp = '$npp'"); $baseFile = mysqli_fetch_array($data); ?>
...
<main id="main" class="main">
    ...
    <?php echo "<script>document.location.href = '../../auth/index.php';</script>"; die; ?>
    <?php endif; ?>
    <?php require_once("../../manager/ui/footer.php"); ?>