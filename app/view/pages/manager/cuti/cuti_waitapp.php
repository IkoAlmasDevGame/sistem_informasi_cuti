                                ...
                                <div class="d-table">
                                    <table class="table-layout" id="example1">
                                        ...
                                        <tbody>
                                            <?php 
                                                $no = 1;
                                                $sql = "SELECT cuti.*, employee.* FROM cuti JOIN employee ON employee.npp = cuti.npp WHERE 
                                                cuti.npp = '$_SESSION[manager]' AND cuti.stt_cuti !='Rejected' ORDER BY cuti.tgl_pengajuan DESC";
